\DIFdelbegin \section{\DIFdel{Measurement Results and Discussion}}
%DIFAUXCMD
\addtocounter{section}{-1}%DIFAUXCMD
\DIFdelend \DIFaddbegin \chapter{\DIFadd{Measurement Results and Discussion}}
\DIFaddend %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Maximum number of sensor nodes simultaneously transmitting their data in RS485 network with desired reserve}}
%DIFAUXCMD
%DIFDELCMD < \begin{tabular}{r|rrrr}
%DIFDELCMD < \multicolumn{1}{c|}{\textbf{RS485}}     & \multicolumn{4}{c}{\multirow{2}{*}{\textbf{Reserve} $R$}}\\
%DIFDELCMD < \multicolumn{1}{c|}{\textbf{data rate}} &   \\
%DIFDELCMD < %%%
\DIFdelFL{$v_{485}$ }%DIFDELCMD < {[%%%
\DIFdelFL{bps}%DIFDELCMD < ]}  &	%%%
\DIFdelFL{0 \%	}%DIFDELCMD < &	%%%
\DIFdelFL{10 \%	}%DIFDELCMD < &	%%%
\DIFdelFL{20 \%	}%DIFDELCMD < &	%%%
\DIFdelFL{30 \%  }%DIFDELCMD < \\ \hline
%DIFDELCMD <   %%%
