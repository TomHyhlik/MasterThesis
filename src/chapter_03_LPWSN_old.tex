...
Takto nainstalovaná senzorová síť by pak měla umožňovat bezdrátové měření veličin např. teplota, vlhkost, CO2, pomocí koncových zařízení sítě, které vydrží několik let napájeny z tužkové baterie při periodě měření několik minut rozmístěných v budově a jejím okolí.
