...
\input{chapter_02_LPwirelessTechnologies_new.tex}

%%%%%%%%%%%%%%%%%%%%%%%%
\part{Practical part}

\input{chapter_03_deviceDesign_new.tex}
\input{chapter_03_results_new.tex}
\input{chapter_04_conclusions_new.tex}
