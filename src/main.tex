...
\includepdf[pages={1}]{zav_prace_opdepsano.pdf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{chapter_01_introduction_diff.tex}

\part{Theoretical part}
									
\input{chapter_02_aCtrlSystems_diff.tex}
\input{chapter_03_LPWSN_diff.tex}

\part{Practical part}

\input{chapter_04_deviceDesign_diff.tex}
\input{chapter_05_testAndResults_diff.tex}
\input{chapter_06_deviceImprove_diff.tex}
\input{chapter_07_conclusions_diff.tex}
