...
Pro lepší mechanické \DIFdelbegin \DIFdel{uspořádání }\DIFdelend \DIFaddbegin \DIFadd{vlastnosti a menší rozměry }\DIFaddend byla navržena verze 2 s navrženým plošným spojem (PCB).
