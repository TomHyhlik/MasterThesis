...
\DIFaddbegin \label{Návrh vylepšení systému}
\DIFaddend V této kapitole jsou navrženy způsoby vylepšení navrženého systému.
...
Původní navržené řešení viz. kapitola \DIFdelbegin \DIFdel{\ref{Návrh WSN} }\DIFdelend \DIFaddbegin \DIFadd{\ref{Návrh senzorové sítě} }\DIFaddend totiž klade důraz na nízký objem přenášených dat v síti RS485.
