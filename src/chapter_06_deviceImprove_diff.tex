...
\DIFdelbegin \DIFdel{Pro lepší mechanické uspořádání byla }\DIFdelend \DIFaddbegin \DIFadd{U původního realizovaného prototypu gatewaye jsou komponenty propojovány drátkama, tudíž mohlo dojít k rozpojení při manipulaci se zařízením a v tomto provedení by bylo náročné vyrobit několik jednotek až desítek kusů pro případné zákazníky.
...
Z těchto důvodů je }\DIFaddend navržena \DIFaddbegin \DIFadd{a realizována }\DIFaddend verze 2 s \DIFdelbegin \DIFdel{navrženým }\DIFdelend plošným spojem (PCB) \DIFaddbegin \DIFadd{navrženým v Eagleu}\DIFaddend .
...
Do zařízení je dále přidán externí stabilizátor, napěťový filtr, \DIFaddbegin \DIFadd{svorkovnice, }\DIFaddend impedanční zakončení sítě RS485 přes přepínač a napěťové ochrany pro linky A, B a napájení. 
...
\DIFaddbegin \DIFadd{Dle návrhu byla gateway realizována viz foto \ref{fig:minigateway_fotoV2}.
}

\DIFaddend \begin{figure}[!h]
    \centering
    \includegraphics[width=0.6\textwidth]{photo_minigatewayV2}
    \caption{\DIFdelbeginFL \DIFdelFL{Návrh }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Foto }\DIFaddendFL gatewaye verze 2\DIFdelbeginFL \DIFdelFL{- foto}\DIFdelendFL }
    \DIFdelbeginFL %DIFDELCMD < \label{fig:minigateway_plosnak}
%DIFDELCMD < %%%
