...
\DIFdelbegin %DIFDELCMD < \begin{lstlisting}%DIFDELCMD < [style=CStyle]
%DIFDELCMD <     /* RHF1S001 data structure */   
%DIFDELCMD <     typedef struct {
%DIFDELCMD <         int16_t temperature;
%DIFDELCMD <         uint8_t humidity;
%DIFDELCMD <         uint16_t period;
%DIFDELCMD <         int8_t rssi;
%DIFDELCMD <         int8_t snr;
%DIFDELCMD <         uint8_t battery;
%DIFDELCMD <     } RHF1S001_data_t;
%DIFDELCMD < 

%DIFDELCMD <     /* Print the data from the structure */
%DIFDELCMD < 	printf("temperature: %d.%d C, ", RHF1S001_data.temperature / 100, RHF1S001_data.temperature % 100);
%DIFDELCMD < 	printf("humidity: %d %%\n", RHF1S001_data.humidity);
%DIFDELCMD < 	printf("period: %d s, ", (int)RHF1S001_data.period);
%DIFDELCMD < 	printf("RSSI: %d dBm, ", RHF1S001_data.rssi);
%DIFDELCMD < 	printf("SNR: %d dB, ", RHF1S001_data.snr);
%DIFDELCMD < 	printf("battery voltage: %d.%d V\r\n", RHF1S001_data.battery/10, RHF1S001_data.battery % 10);
%DIFDELCMD < 

%DIFDELCMD <     /* Put the data into 6B long buffer, that is transmitted to the master */
%DIFDELCMD < 	buffer[0] = RHF1S001_data.temperature & 0xFF;
%DIFDELCMD < 	buffer[1] = RHF1S001_data.temperature >> 8;
%DIFDELCMD < 	buffer[2] = RHF1S001_data.humidity;
%DIFDELCMD < 	buffer[3] = RHF1S001_data.rssi;
%DIFDELCMD < 	buffer[4] = RHF1S001_data.snr;
%DIFDELCMD < 	buffer[5] = RHF1S001_data.battery;
...
\DIFdelbegin %DIFDELCMD < \begin{lstlisting}%DIFDELCMD < [style=CStyle]
%DIFDELCMD <     /* IMA_tempPress data structure */   
%DIFDELCMD <     typedef struct {
%DIFDELCMD <         int16_t temperature;
%DIFDELCMD <         uint16_t pressure;
%DIFDELCMD <         int8_t rssi;
%DIFDELCMD <         int8_t snr;
%DIFDELCMD <     } IMA_tempPress_data_t;
%DIFDELCMD <     

%DIFDELCMD <     /* print the data from the structure */
%DIFDELCMD < 	printf("temperature: %d.%d C, ", IMA_tempPress_data.temperature / 100, IMA_tempPress_data.temperature % 100);
%DIFDELCMD < 	printf("pressure: %d.%d Pa\r\n", IMA_tempPress_data.pressure/10, IMA_tempPress_data.pressure % 10);
%DIFDELCMD < 	printf("RSSI: %d dBm, SNR: %d dB\r\n", IMA_tempPress_data.rssi, IMA_tempPress_data.snr);
%DIFDELCMD < 

%DIFDELCMD <     /* Put the data into 6B long buffer, that is transmitted to the K4 server */
%DIFDELCMD < 	buffer[0] = IMA_tempPress_data.temperature & 0xFF;
%DIFDELCMD < 	buffer[1] = IMA_tempPress_data.temperature >> 8;
%DIFDELCMD < 	buffer[2] = IMA_tempPress_data.pressure & 0xFF;
%DIFDELCMD < 	buffer[3] = IMA_tempPress_data.pressure >> 8;
%DIFDELCMD < 	buffer[4] = IMA_tempPress_data.rssi;
%DIFDELCMD < 	buffer[5] = IMA_tempPress_data.snr;
%DIFDELCMD < \end{lstlisting}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{lstlisting}[style=CStyle]
