...
%DIFDELCMD < %%%
\DIFdelend Příklad příkazu: FF 1F 10 0D 00 D0 F6 1F 01 29 AD 0A 5A 27 FF FF DE 09 E1.
\DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend Data příkazu jsou níže rozepsána v tabulce \ref{table:prikladprikazpruchod}.
