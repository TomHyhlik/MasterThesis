...
Navržená gateway senzorové sítě je připojena do infrastruktury přístupového systému stejně jako zařízení s oznacenim "CKP" (dale jen CKP), které ovládá čtečku a dveřní zámek, tudíž gateway musí podporovat stejný komunikační protokol jako CKP zařízení. 
