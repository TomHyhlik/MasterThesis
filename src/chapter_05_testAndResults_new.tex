...
Testování probíhalo od 21$^{st}$ září do 31$^{th}$ října, tedy v době přítomnosti studentů a zaměstnanců v testovaných prostorách.
Během této doby kontrolní panel přijal 1~876~978 paketů (14~074~522 B) a odeslal 1~101~556 paketů (8~295~219 B) v síti RS485. 
