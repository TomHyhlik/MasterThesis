...
Dostupné transceivery na trhu se pohybují okolo \$5–20 od více různých výrobců, stejnětak je i na trhu dostupných mnoho BLE koncových zařízení, ale mnohdy jsou tato koncová zařízení kompatibilní pouze vrámci jednoho výrobce??

Bluetooth has the big advantage, taht it's built in almost every mobile phone, tablet or laptop so there are more options to control the network.
