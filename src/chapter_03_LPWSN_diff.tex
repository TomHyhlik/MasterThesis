...
\DIFaddbegin \label{Výběr bezdrátové technologie pro senzorovou síť}
\DIFaddend Tato kapitola porovnává dostupné bezdrátové technologie vhodné pro tento vybraný případ senzorové sítě a na závěr vysvětluje která technologie byla nakonec vybrána a z jakých důvodů.
