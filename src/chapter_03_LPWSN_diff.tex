...
Mezi hlavní požadavky na navrženou senzorovou síť pro tento vybraný případ patří jednoduchá napojitelnost na infrastrukturu jiného systému. Pro tento vybraný případ se konkrétně jedná o infrastrukturu již zavedeného přístupového systému v budovách několika podniků.
Takto nainstalovaná senzorová síť by pak měla umožňovat bezdrátové měření veličin např. teplota, vlhkost, CO\textsubscript{2}, pomocí koncových zařízení sítě, která vydrží několik let napájena z baterie při periodě měření několik minut rozmístěných v budově a jejím okolí.
...
\begin{table}[!h]
  ...
  \centering
  \begin{ctucolortab}    
  \DIFdelbeginFL %DIFDELCMD < \begin{tabular}{|p{1.5cm}||p{1.4cm}|p{1.5cm}|p{1.4cm}|p{1.5cm}|p{2.8cm}|}
%DIFDELCMD <       %%%
\DIFdelendFL \DIFaddbeginFL \begin{tabular}{|p{1.5cm}||p{1.3cm}|p{1.5cm}|p{1.4cm}|p{1.5cm}|p{2.8cm}|}
      \DIFaddendFL \hline
