...
Vyvinutá aplikace je rozdělena na nékolik nezávislých pod   programů viz tabulka \ref{table:sw_div}.
...
\begin{table}[h]
    ...
    LoRa            &  knihovna zahrnující komunikaci LoRa transceiverem po rozhranní SPI    \\
    eeprom          &  knihovna zahrnující zápis do non-volatile paměti procesoru EEPROM     \\
    LoRa_sensors    &  PA5        \\
    LoRaWAN_packet  &  PA5        \\
    rs485_protocol  &  PA5        \\
    usb             &  PA5        \\
    ...
    \end{tabular}
    \end{ctucolortab}
    \caption{Rozdělení aplikace gatewaye na nezávislé programy}
    \label{table:sw_div}
\end{table}
