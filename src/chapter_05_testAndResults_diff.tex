...
Avšak vzhledem k povaze systému, tedy systému s primární funkcí řízení přístupu do omezených oblastí, se za nejhorší scénář považuje nepřekonatelný limit %DIF <  velikosti paketu.
\DIFaddbegin \DIFadd{velikosti paketu.
}\DIFaddend 
...
$l_{MAX}$ & maximální délka paketu \\
 ...
 P        & \DIFdelbegin \DIFdel{počt }\DIFdelend \DIFaddbegin \DIFadd{počet }\DIFaddend paketů k přenesení dat z koncového zařízení \\
\end{tabular}
...
Např. v senzorové síti může být až \DIFdelbegin \DIFdel{162 }\DIFdelend \DIFaddbegin \DIFadd{54 }\DIFaddend koncových zařízení připojených ke gatewayi, která je napojena na síť RS485 s přenosovou rychlostí \DIFdelbegin \DIFdel{115200}\DIFdelend \DIFaddbegin \DIFadd{38400}\DIFaddend ~bps a rezervou 10 \% nebo \DIFdelbegin \DIFdel{126 }\DIFdelend \DIFaddbegin \DIFadd{42 }\DIFaddend koncových zařízení s přenosovou rychlostí \DIFdelbegin \DIFdel{115200}\DIFdelend \DIFaddbegin \DIFadd{38400}\DIFaddend ~bps a rezervou 30 \%.
