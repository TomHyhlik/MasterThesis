...
%DIF <  \end{equation}
\DIFaddbegin \DIFadd{Aby bylo zabráněno přetížení sítě RS485, maxímální počet koncových zařízení připojených ke gatewayi $ S_{MAX} $ je možné vypočítat vztahem:
}\DIFaddend 
