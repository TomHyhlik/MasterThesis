%DIF <  \chapter{Conclusions}
\chapter{Závěr}
\DIFaddbegin 

\DIFadd{V této přáci jsou diskutovány podmínky rozšíření stávajícího systému řízení přístupu pracujícího v průmyslově standardizované síti RS485 s bezdrátovou senzorovou sítí založenou na jednokanálovém režimu LoRaWAN.
 }\DIFaddend 
