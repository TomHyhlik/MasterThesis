...
Pro tento vybraný případ \DIFaddbegin \DIFadd{návrhu FW }\DIFaddend není využit RTOS (Real Time Operating System), jelikož zde není potřeba řešení více úloh souběžně. 
