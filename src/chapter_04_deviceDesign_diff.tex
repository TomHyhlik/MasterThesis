...
Konkrétní komponenty jsou: }\DIFaddend Dragino LoRa Shield \cite{RFM95w}\DIFdelbegin \DIFdel{a }\DIFdelend \DIFaddbegin \DIFadd{, }\DIFaddend RS485 transceiver \cite{rs485tr} \DIFdelbegin \DIFdel{, viz.
...
\begin{figure}[!h]
    ...
    \caption{\DIFdelbeginFL \DIFdelFL{Gateway block }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Blokový }\DIFaddendFL diagram \DIFaddbeginFL \DIFaddFL{navržené gatewaye senzorové sítě}\DIFaddendFL , RFM95w \cite{RFM95w}, RS485 transceiver \cite{rs485tr}, NUCLEO-L073RZ \cite{nucleoST}}
