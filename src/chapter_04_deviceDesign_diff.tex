...
Vyvinutá aplikace je rozdělena na nékolik nezávislých programů viz tabulka \ref{table:sw_div}.
}\DIFaddend 
...
\DIFaddbegin \begin{table}[h]
    ...
    \end{tabular}
    \end{ctucolortab}
    \caption{\DIFaddFL{Rozdělení aplikace gatewaye na nezávislé programy}}
    \label{table:sw_div}
\end{table}
