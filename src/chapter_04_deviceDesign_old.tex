...
Data z koncových zařízení jsou odesílána na servere řízení přístupu příkazem "průchod", který má fixní velikost a po přidání adresy koncového zařízení o velikosti 4 B zde už zbývá poze 6 B pro payload dat z koncového zařízení, což je velké omezení.
LoRaWAN protokol používá packet, jehož samotná hlavička je o minimální velikosti ?? B. Jako jedíné možné řešení je tedy dekódovat a dešifrovat LoRaWAN packet přímo v gatewayi, a odeslat pouze vybraná data z payloadu koncovéjo zařízení na server řízení přístupu skrze kontrolní panel. 
...
\section{Návrh WSN gatewaye}
 ...
 pro komunikaci s control panelem přístupového systému firmy IMA zajišťuje posílání dat z koncových zařízení příkazem "průchod", 
...
LoRaWAN protokol používá 4-byte dlouhé adresy pro koncová zařízení. 
