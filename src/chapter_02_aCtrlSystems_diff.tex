...
\DIFaddbegin \DIFadd{Běžně se s přístupovými systémy setkáváme zejména v kancelářních budovách, ale i nemocnicích, školách, úřadech apod.
...
\begin{figure}[!h]
    \centering
    \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=130mm]{Architetcture-of-Access-Control-System}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=1\textwidth]{Architetcture-of-Access-Control-System}
