...
% % -------------------------
\bibitem[14]{Implement Smart Farm with IoT Technology}
...
% -------------------------
\bibitem[15]{accessControlSystem_eiprocus}
...
\bibitem[23]{wirelessMBus_automatizace}
[Online]. Available:
\url{
...
% % % -------------------------
\bibitem[19]{Analysis of Propagation Link for Remote Weather}
...
% -------------------------
\bibitem[1110]{accessControlSystem_eiprocus}
% \textit{
...
% -------------------------
\bibitem[1111]{high density LPWAN}
% \textit{
...
% % -------------------------
\bibitem[1113]{MURS Band for LPWAN Applications}
% \textit{
...
% % -------------------------
\bibitem[1114]{A comparative study of LPWAN technologies for large-scale IoTdeployment}
% \textit{
...
% % -------------------------
\bibitem[1115]{Long-Range Communications in Unlicensed Bands}
...
% % -------------------------
\bibitem[1116]{Implement Smart Farm with IoT Technology}
...
% % -------------------------
\bibitem[1117]{Radio Data Infrastructure for Remote Monitoring}
